...
# 学習時間を出す
  ...
  def daytime
    microposts_day =
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.beginning_of_day...Time.current.tomorrow.beginning_of_day)
  ...
  def weektime
    microposts_week =
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.beginning_of_week...Time.current.next_week.beginning_of_day)
  ...
  def monthtime
    microposts_month =
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.beginning_of_month...Time.current.next_month.beginning_of_day)
  ...
  def daytime_before
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.zone.yesterday.beginning_of_day...Time.current.beginning_of_day)
  ...
  def weektime_before
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.prev_week.beginning_of_week...Time.current.beginning_of_week)
  ...
  def monthtime_before
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.prev_month.beginning_of_month...Time.current.beginning_of_month)
...
# グラフの学習時間を表示させる
  def daytime_before_2days
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(2.days).beginning_of_day...Time.zone.yesterday.beginning_of_day)
  ...
  def daytime_before_3days
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(3.days).beginning_of_day...Time.current.ago(2.days).beginning_of_day)
  ...
  def daytime_before_4days
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(4.days).beginning_of_day...Time.current.ago(3.days).beginning_of_day)
  ...
  def weektime_before_2weeks
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(2.weeks).beginning_of_week...Time.current.prev_week.beginning_of_week)
  ...
  def weektime_before_3weeks
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(3.weeks).beginning_of_week...Time.current.ago(2.weeks).beginning_of_week)
  ...
  def weektime_before_4weeks
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(4.weeks).beginning_of_week...Time.current.ago(3.weeks).beginning_of_week)
  ...
  def monthtime_before_2months
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(2.months).beginning_of_month...Time.current.prev_month.beginning_of_month)
  ...
  def monthtime_before_3months
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(3.months).beginning_of_month...Time.current.ago(2.months).beginning_of_month)
  ...
  def monthtime_before_4months
    ...
    Micropost.where("user_id = :user_id", user_id: id)
    .where(start_at: Time.current.ago(4.months).beginning_of_month...Time.current.ago(3.months).beginning_of_month)
